...
// ./waf --run "two-targets-fake --RngRun=2 --maxRange=400 --frequency=50 --topo=ddos-simple --output=test"
...
main(int argc, char* argv[]) {
  ...
  ndn::L3RateTracer::InstallAll("src/ndnSIM/Results/two-targets-fake/" + outFile + ".txt",
                                Seconds(0.5));
  Simulator::Run();
  Simulator::Destroy();
